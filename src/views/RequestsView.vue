<template>
    <div class="m-5">
      <div class="card  shadow bg-body-tertiary rounded">
        <h2 class="red-color-text fw-bold text-center mt-3">{{$t('titles.requests')}}</h2>
        ...
        <div class="card-body">
          ...
          <TableRequestsComponent></TableRequestsComponent>
  ...
  <script setup>
import TableRequestsComponent from '@/components/requests/TableRequestsComponent.vue';
