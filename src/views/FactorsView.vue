<template>
    <div class="m-5">
      <div class="card  shadow bg-body-tertiary rounded">
        <h2 class="red-color-text fw-bold text-center mt-3">{{$t('titles.factors')}}</h2>
        ...
        <div class="card-body">
          ...
          <TableFactorsComponent></TableFactorsComponent>
  ...
  <script setup>
import TableFactorsComponent from '@/components/factors/TableFactorsComponent.vue';
