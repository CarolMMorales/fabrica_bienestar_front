<template>
  <div>
    <div class="table-responsive m-1">
      <DataTable :data="categories.category" :columns="columns" class="table table-striped table-bordered display mt-2"
        :options="options">
        <thead>
          <tr>
            <th>idCategory</th>
...
const options = {
  ...
  columnDefs: [
    ...
    { targets: 2, width: '20%' }, // Ancho del tercera columna (strCategoryDescription)
